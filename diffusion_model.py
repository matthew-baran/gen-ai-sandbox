...
def load_transformed_dataset():
    ...
    train = StanfordCars(
        root_path="./stanford_cars/cars_train/cars_train", transform=data_transform
    )

    test = StanfordCars(
        root_path="./stanford_cars/cars_test/cars_test", transform=data_transform
    )
...
data = StanfordCars(root_path="./stanford_cars/cars_train/cars_train")
show_images(data)
